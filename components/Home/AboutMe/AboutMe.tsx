        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Saidul Mursalin Khan, and I am a passionate
                software engineer and problem solver, dedicated to creating
                impactful codes that thrive on the internet. My journey in
                computer science began in 2019 when I delved into the world of
                Artificial Intelligence. Little did I know that programming
            ...
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                in full stack software development. In the realm of{" "}
                <span className="text-AAsecondary">Software Development</span>,
                I am dedicated to pushing boundaries and driving advancements.
                With experience working alongside esteemed organization like{" "}
                <span className="text-AAsecondary">Logic Software Limited</span>
                , where I played a key role in developing a web based face
                recognition system to detect second timer interview candidates
                of <span className="text-AAsecondary">Logic Software</span> , my
                passion for full stack development and continuous learning
                drives me to make a positive impact and advance technology.
              </span>
            </div>
          ...
          <div className="group relative lg:w-96 lg:h-96 md:w-72 md:h-72 md:block hidden ">
            ...
            <div className="absolute w-5/6 h-5/6  rounded overflow-hidden">
              ...
              <Img
                src={"/img/Portfolio-portrait-4.jpg"}
