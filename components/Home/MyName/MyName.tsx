  ...
  return (
    ...
    >
      ...
      >
        ...
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">javascript ecosystem</span>,
        ...
        <span className="text-AAsecondary">Backend and Frontend</span> of {" "}
        <span className="text-AAsecondary">Web & Mobile Applications</span>.
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
