      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/Saidul-M-Khan"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://linkedin.com/in/saidul-m-khan"} />
          </div>
      ...
      >
        <div className="flex flex-col space-y-32 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:saidulmursalinkhan@gmail.com" target={"_blank"} rel="noreferrer">
