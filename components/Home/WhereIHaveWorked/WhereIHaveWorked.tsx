...
import LogicSoft from "./Descriptions/LogicSoft";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("LogicSoft");
  return (
...
const CompaniesBar = props => {
  ...
  return (
    ...
    >
      ...
      > */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[35px] translate-y-1 md:w-0.5  
        rounded md:order-1 order-2  "
      >
        {/* // ? animated left bar */}
        <motion.div
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        ...
        <CompanyButton
            ...
            CompanyName="Logic Software"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="LogicSoft"
