...
export default function Home() {
  ...
  const meta = {
    title: "Saidul Mursalin Khan - Software Engineer",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://khansaab.com`} />
        <link rel="canonical" href={`https://khansaab.com`} />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/Saidul-M-Khan"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
